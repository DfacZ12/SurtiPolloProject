...
const UpdateUser = ({ cedula, onClose, onUpdated }: { cedula: number, onClose: () => void, onUpdated: () => void }) => {
  const auth = useAuth();
  ...
  const handleSelectUser = async () => {
    try {
      const response = await axios.get(`${API_URL}/selectUser/${cedula}`, {
