...
export default function HomePage() {
  ...
  // return <h1 className="text-2xl font-bold">Bienvenido {auth.getUser()?.name} - CC: {auth.getUser()?.cc}</h1>
  return (
          ...
          <div id="collapseMenu"
            ...
            <div
              ...
              <div className="flex items-center max-lg:flex-col-reverse max-lg:ml-auto gap-8">
                <div
                  className="flex w-full bg-gray-100 px-4 py-2.5 rounded-sm outline-0 border border-gray-200 focus-within:border-blue-600 focus-within:bg-transparent transition-all">
                  <input type='text' placeholder='Search something...'
                    className="w-full text-sm bg-transparent rounded-sm outline-0 pr-2" />
                  ...
                  <div
                    ...
                    <div className="w-full">
                      <a href="javascript:void(0)"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" className="w-[18px] h-[18px] font-medium mr-3 fill-current"
                          viewBox="0 0 512 512">
                          <path
                      ...
                      <a href="javascript:void(0)"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                          className="w-[18px] h-[18px] font-medium mr-3 fill-current" viewBox="0 0 24 24">
                          <path
        ...
        <div className="flex items-start">
          <nav id="sidebar" className="lg:min-w-[280px] w-max max-lg:min-w-8">
            <div id="sidebar-collapse-menu" style={{ height: "calc(100vh - 72px)" }}
              ...
              <div className="mt-6">
                <h6 className="text-blue-600 text-sm font-semibold px-4">Information</h6>
              ...
              <div className="mt-6">
                <h6 className="text-blue-600 text-sm font-semibold px-4">General Settings</h6>
                <ul className="mt-3 space-y-1.5">
                  <li>
                    <a href="javascript:void(0)"
                      className="text-slate-800 text-[15px] font-medium flex items-center hover:bg-gray-100 rounded-md px-4 py-2 transition-all">
          ...
          <button id="toggle-sidebar"
            className="lg:hidden w-8 h-8 z-[100] fixed top-[74px] left-[10px] cursor-pointer bg-[#007bff] flex items-center justify-center rounded-full outline-0 transition-all duration-500">
